...
class Assignment2 {
    ...
    public static void main(String args[]) throws IOException {
        ...
        Assignment2 reference = new Assignment2();  //Instance of class created to call methods
        ...
        for (int x=1;x<out1_string_split.length;x++) {
           ...
           //HTML parser used for getting the text
            ...
            Assignment2 func = new Assignment2();
    ...
    public void weight_filewrite(ArrayList<HashMap<String,Double>> list_writeup, int totalfiles_writeup){
        ...
        for (int i=0;i<totalfiles_writeup-1;i++){
            ...
            try {
                FileWriter file_write = new FileWriter("/Users/sharad/IdeaProjects/Project2_IR/src/"+i+".txt");
